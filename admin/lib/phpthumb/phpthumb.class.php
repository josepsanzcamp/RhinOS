...
//		}
	...
	function RenderOutput() {
		if (!$this->useRawIMoutput && !(is_resource($this->gdimg_output) || (is_object($this->gdimg_output) && $this->gdimg_output instanceOf \GdImage))) {
	...
	function setOutputFormat() {
		...
		$this->f=(string)$this->f; // FOR PHP8.1
	...
	function ImageMagickCommandlineBase() {
		...
		if (is_null($commandline)) {
			...
			$this->config_imagemagick_path=(string)$this->config_imagemagick_path; // FOR PHP8.1
