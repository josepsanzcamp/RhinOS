...
*/
// for compatibility
include_once("saltos.php");
include_once("compat.php");

// abstract functions
function db_connect() {
	$php="database/".getDefault("db/type").".php";
	if(!file_exists($php)) $php="admin/database/".getDefault("db/type").".php";
...
function db_query($query,$fetch="query") {
	...
	// DO QUERY
	if(!getDefault("db/link")) db_connect();
	$func=__FUNCTION__."_".getDefault("db/type");
